...
//        self.calendarMenuView = CVCalendarMenuView(frame: CGRectMake(0, 0, 300, 15))
    ...
    extension SyllabusTrackerViewController: CVCalendarViewDelegate, CVCalendarMenuViewDelegate {
...
extension SyllabusTrackerViewController: CVCalendarViewAppearanceDelegate {
...
extension SyllabusTrackerViewController {
